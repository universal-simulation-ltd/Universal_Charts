  ...
  return (
    <div className="space-y-3">
      ...
      <textarea
        ...
        spellCheck={false}
        rows={8}
        className="w-full rounded-md border border-slate-300 px-3 py-2 font-mono text-xs leading-relaxed focus:border-orange-500 focus:ring-2 focus:ring-orange-100 outline-none dark:bg-slate-950 dark:border-slate-700 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:border-orange-500 dark:focus:ring-orange-500/30"
